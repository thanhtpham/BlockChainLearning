...
contract("ChainList", function (accounts) {
  ...
  //       sellerBalanceBeforeBuy = web3.utils
  //         .fromWei(web3.eth.getBalance(seller).toString(), "ether")
  //         .toNumber();
  //       buyerBalanceBeforeBuy = web3.utils
  //         .fromWei(web3.eth.getBalance(buyer).toString(), "ether")
  //         .toNumber();
  ...
  //       sellerBalanceAfterBuy = web3.utils
  //         .fromWei(web3.eth.getBalance(seller).toString(), "ether")
  //         .toNumber();
  //       buyerBalanceAfterBuy = web3.utils
  //         .fromWei(web3.eth.getBalance(buyer).toString(), "ether")
  //         .toNumber();
